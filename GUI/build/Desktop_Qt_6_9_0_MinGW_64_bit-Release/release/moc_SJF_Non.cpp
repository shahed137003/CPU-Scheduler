...
namespace {
struct qt_meta_tag_ZN7SJF_NonE_t {};
} // unnamed namespace

template <> constexpr inline auto SJF_Non::qt_create_metaobjectdata<qt_meta_tag_ZN7SJF_NonE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<SJF_Non, qt_meta_tag_ZN7SJF_NonE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject SJF_Non::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7SJF_NonE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7SJF_NonE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN7SJF_NonE_t>.metaTypes,
    nullptr
} };
...
void *SJF_Non::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7SJF_NonE_t>.strings))
