...
static constexpr auto qt_meta_stringdata_ZN7SJF_NonE = QtMocHelpers::stringData(
    "SJF_Non",
    "requestProcessStep",
    "",
    "processStep"
...
Q_CONSTINIT static const uint qt_meta_data_ZN7SJF_NonE[] = {
...
Q_CONSTINIT const QMetaObject SJF_Non::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN7SJF_NonE.offsetsAndSizes,
    qt_meta_data_ZN7SJF_NonE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7SJF_NonE_t,
        // Q_OBJECT / Q_GADGET
...
void SJF_Non::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (SJF_Non::*)();
            if (_q_method_type _q_method = &SJF_Non::requestProcessStep; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *SJF_Non::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7SJF_NonE.stringdata0))
