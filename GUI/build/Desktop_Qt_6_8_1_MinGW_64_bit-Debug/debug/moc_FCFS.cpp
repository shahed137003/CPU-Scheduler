...
static constexpr auto qt_meta_stringdata_ZN4FCFSE = QtMocHelpers::stringData(
    "FCFS",
    "requestProcessStep",
    "",
    "processStep"
...
Q_CONSTINIT static const uint qt_meta_data_ZN4FCFSE[] = {
...
Q_CONSTINIT const QMetaObject FCFS::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN4FCFSE.offsetsAndSizes,
    qt_meta_data_ZN4FCFSE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN4FCFSE_t,
        // Q_OBJECT / Q_GADGET
...
void FCFS::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (FCFS::*)();
            if (_q_method_type _q_method = &FCFS::requestProcessStep; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *FCFS::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN4FCFSE.stringdata0))
