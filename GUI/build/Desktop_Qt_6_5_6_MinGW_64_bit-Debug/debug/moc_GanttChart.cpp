...
Q_CONSTINIT static const qt_meta_stringdata_CLASSGanttChartENDCLASS_t qt_meta_stringdata_CLASSGanttChartENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(30, 0),  // ""
        QT_MOC_LITERAL(31, 16),  // "std::queue<char>"
        QT_MOC_LITERAL(48, 9),  // "processes"
        QT_MOC_LITERAL(58, 30),  // "std::queue<std::vector<float>>"
        QT_MOC_LITERAL(89, 9),  // "timeSlots"
        QT_MOC_LITERAL(99, 4),  // "live"
        QT_MOC_LITERAL(104, 17)   // "handleUpdateGantt"
    },
    "GanttChart",
    "requestUpdateGantt",
    "",
...
void GanttChart::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (GanttChart::*)(const std::queue<char> & , const std::queue<std::vector<float>> & , bool );
