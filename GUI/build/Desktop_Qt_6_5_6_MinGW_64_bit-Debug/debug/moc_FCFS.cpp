...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSFCFSENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSFCFSENDCLASS_t qt_meta_stringdata_CLASSFCFSENDCLASS = {
    {
        QT_MOC_LITERAL(0, 4),  // "FCFS"
...
void FCFS::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (FCFS::*)();
            if (_t _q_method = &FCFS::requestProcessStep; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
